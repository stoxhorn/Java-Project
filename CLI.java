...
public class CLI implements UserInterface {
    ...
    public static void main(String[] args) {
        ...
        This is the main method which is run when running this class.
        ui is a new CLI, and it then starts a game with with the number of players, gotten with the method getParameter
